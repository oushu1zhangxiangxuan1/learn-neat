...
def run(config_file):
    ...
    p.add_reporter(neat.Checkpointer(5, filename_prefix="checkpoint/{}/housing-ck".format(NAME)))
    ...
    print("\nTrain avg loss: {}".format(train_accuracy), flush=True)
    ...
    print("\nTest  avg loss: {}".format(test_accuracy), flush=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_data", help="train data file absolute path", type=str, default='../../testdata/housing/housing_train.csv')
    parser.add_argument("--test_data", help="test data file absolute path", type=str, default='../../testdata/housing/housing_test.csv')
